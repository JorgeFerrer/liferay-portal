...
public class BlogsEntryLocalServiceImpl extends BlogsEntryLocalServiceBaseImpl {
	...
	protected void notifySubscribers(
		...
		LocalizedValue subjectLocalizedValue = null;
		LocalizedValue bodyLocalizedValue = null;

		if (serviceContext.isCommandUpdate()) {
			subjectLocalizedValue = blogsSettings.getEmailEntryUpdatedSubject();
			bodyLocalizedValue = blogsSettings.getEmailEntryUpdatedBody();
		}
		else {
			subjectLocalizedValue = blogsSettings.getEmailEntryAddedSubject();
			bodyLocalizedValue = blogsSettings.getEmailEntryAddedBody();
		}
		...
		subscriptionSender.setLocalizedBodyMap(bodyLocalizedValue);
		subscriptionSender.setLocalizedSubjectMap(subjectLocalizedValue);
