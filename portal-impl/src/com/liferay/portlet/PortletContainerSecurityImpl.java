...
//		}
	...
	public ActionResult processAction(
		...
		try {
			...
			return handleActionError(request, response, portlet, e);
		}
	...
	protected ActionResult handleActionError(
			HttpServletRequest request, HttpServletResponse response,
	...
	public void render(
		...
		try {
			...
			handleRenderError(request, response, portlet);
		}
		catch (PortletContainerException e) {
			throw e;
		}
	...
	protected void handleRenderError(
			HttpServletRequest request, HttpServletResponse response,
			Portlet portlet)
		throws PortletContainerException {
	...
	public void serveResource(
		...
		try {
			...
			handleServeResourceError(request, response, portlet, e);
		}
		catch (PortletContainerException e) {
			throw e;
		}
	...
	protected void handleServeResourceError(
			HttpServletRequest request, HttpServletResponse response,
			Portlet portlet, PrincipalException e)
		throws PortletContainerException {
