...
public class PermissionPersistenceImpl extends BasePersistenceImpl<Permission>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(PermissionModelImpl.ENTITY_CACHE_ENABLED,
			...
			PermissionModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(PermissionModelImpl.ENTITY_CACHE_ENABLED,
		...
		if (isNew || !PermissionModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((permissionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(permissionModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(permissionModelImpl.getCompanyId())
					};
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Permission> findByCompanyId(long companyId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Permission> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
	...
	public List<Permission> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Permission permission : list) {
				if ((companyId != permission.getCompanyId())) {
					list = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Permission findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchPermissionException, SystemException {
		List<Permission> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Permission findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchPermissionException, SystemException {
		int count = countByCompanyId(companyId);

		List<Permission> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Permission[] findByCompanyId_PrevAndNext(long permissionId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, permission,
					companyId, orderByComparator, true);

			array[1] = permission;

			array[2] = getByCompanyId_PrevAndNext(session, permission,
	...
	protected Permission getByCompanyId_PrevAndNext(Session session,
		Permission permission, long companyId,
	...
	public void removeByCompanyId(long companyId) throws SystemException {
		for (Permission permission : findByCompanyId(companyId)) {
			remove(permission);
		}
	}
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "permission.companyId = ?";
