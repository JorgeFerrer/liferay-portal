...
<%
shoppingGroupServiceOverriddenConfiguration = BeanParamUtil.setParameterMap(ShoppingGroupServiceOverriddenConfiguration.class, shoppingGroupServiceOverriddenConfiguration, request.getParameterMap(), "preferences--", StringPool.DOUBLE_DASH);
%>
