...
<%
socialGroupStatisticsPortletInstanceConfiguration = BeanParamUtil.setParameterMap(SocialGroupStatisticsPortletInstanceConfiguration.class, socialGroupStatisticsPortletInstanceConfiguration, request.getParameterMap(), "preferences--", StringPool.DOUBLE_DASH);
