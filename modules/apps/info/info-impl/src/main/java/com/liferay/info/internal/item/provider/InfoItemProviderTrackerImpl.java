...
public class InfoItemProviderTrackerImpl implements InfoItemProviderTracker {
	...
	public List<String> getInfoItemClassNames() {
		return new ArrayList<>(_infoItemProvidersServiceTrackerMap.keySet());
	}
	...
	protected void activate(BundleContext bundleContext) {
		...
		for (Class infoItemProviderClass : infoItemProviderClasses) {
			ServiceTrackerMap<String, InfoItemProvider>
				stringObjectServiceTrackerMap =
					ServiceTrackerMapFactory.openSingleValueMap(
						bundleContext, infoItemProviderClass, null,
						new ItemClassNameServiceReferenceMapper(bundleContext));

			_infoItemProvidersServiceTrackerMap.put(
				infoItemProviderClass.getName(),
				stringObjectServiceTrackerMap);
		}
	}

	private Map<String, ServiceTrackerMap<String, InfoItemProvider>>
		_infoItemProvidersServiceTrackerMap = new HashMap<>();
