			...
			try {
				...
				String portletPropsServletContextName =
					(String)getMethod.invoke(
						null, "contacts-portlet-deployment-context");
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
				"com.liferay.contacts.exception." +
					"DuplicateEntryEmailAddressException")) {

			return new com.liferay.contacts.exception.
				DuplicateEntryEmailAddressException(
		...
		if (className.equals(
			...
			return new com.liferay.contacts.exception.EntryFullNameException(
				throwable.getMessage(), throwable.getCause());
		}
		...
		if (className.equals(
			...
			return new com.liferay.contacts.exception.NoSuchEntryException(
				throwable.getMessage(), throwable.getCause());
		}
