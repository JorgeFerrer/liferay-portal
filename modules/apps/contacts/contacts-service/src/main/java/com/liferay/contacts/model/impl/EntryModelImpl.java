...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
	...
	public static final String TABLE_SQL_CREATE = "create table Entry (entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,fullName VARCHAR(75) null,emailAddress VARCHAR(75) null,comments VARCHAR(75) null)";
	...
	public static final String ORDER_BY_SQL = " ORDER BY Entry.fullName ASC";
