...
<%
FlagsGroupServiceConfiguration flagsGroupServiceConfiguration = ConfigurationFactoryUtil.getConfiguration(FlagsGroupServiceConfiguration.class, new CompanyServiceSettingsLocator(themeDisplay.getCompanyId(), "com.liferay.flags"));
%>
