	...
	>
		...
		>
			...
			<liferay-ui:search-container-column-text name="scope">
				<c:choose>
					<c:when test="<%= ObjectClassDefinitionExt.Scope.COMPANY.equals(configurationModel.getScope()) %>">
						<liferay-ui:message key="default-settings-for-all-instances" />
					</c:when>
					<c:when test="<%= ObjectClassDefinitionExt.Scope.GROUP.equals(configurationModel.getScope()) %>">
						<liferay-ui:message key="default-configuration-for-all-sites" />
					</c:when>
					<c:when test="<%= ObjectClassDefinitionExt.Scope.PORTLET_INSTANCE.equals(configurationModel.getScope()) %>">
						<liferay-ui:message key="default-configuration-for-application" />
					</c:when>
					<c:when test="<%= ObjectClassDefinitionExt.Scope.SYSTEM.equals(configurationModel.getScope()) %>">
