...
public class BuildingsSiteInitializer implements SiteInitializer {
	...
	public static final String KEY = "buildings-site-initializer";
	...
	public void initialize(long groupId) throws InitializationException {
		try {
			...
			_addDisplayPageEntry(
				"Buildings Entry", entryFragmentEntries,
				_PATH + "/page_templates", "buildings_entry.jpg", ddmStructure,
				fileEntries, serviceContext);
	...
	private List<FileEntry> _addFileEntries(ServiceContext serviceContext)
		...
		Folder folder = _dlAppLocalService.addFolder(
			serviceContext.getUserId(), serviceContext.getScopeGroupId(),
			DLFolderConstants.DEFAULT_PARENT_FOLDER_ID, _SITE_INITIALIZER_NAME,
	...
	private List<FragmentEntry> _addFragmentEntries(
		...
		FragmentCollection fragmentCollection =
			_fragmentCollectionLocalService.addFragmentCollection(
				serviceContext.getUserId(), serviceContext.getScopeGroupId(),
				_SITE_INITIALIZER_NAME, null, serviceContext);
	...
	private DDMStructure _addJournalArticleDDMStructure(
		...
		nameMap.put(siteDefaultLocale, "Buildings Entry");

		Map<Locale, String> descriptionMap = new HashMap<>();

		descriptionMap.put(siteDefaultLocale, "Buildings Entry");

		URL definitionURL = _bundle.getEntry(
			_PATH + "/journal/structures/buildings_entry/definition.json");
		...
		URL layoutURL = _bundle.getEntry(
			_PATH + "/journal/structures/buildings_entry/layout.json");
		...
		return _ddmStructureLocalService.addStructure(
			...
			_portal.getClassNameId(JournalArticle.class), "BUILDINGS_ENTRY",
	...
	private List<JournalArticle> _addJournalArticles(
		...
		Enumeration<URL> enumeration = _bundle.findEntries(
			_PATH + "/journal/structures/buildings_entry/content", "*", false);
		...
		while (enumeration.hasMoreElements()) {
			...
			JournalArticle article = _journalArticleLocalService.addArticle(
				serviceContext.getUserId(), serviceContext.getScopeGroupId(), 0,
				nameMap, null, content, "BUILDINGS_ENTRY", "BUILDINGS_ENTRY",
				serviceContext);
	...
	private static final String _LAYOUT_70_30 = "buildings_70_30_width_limited";
	...
	private static final String _THEME_ID = "classic";
