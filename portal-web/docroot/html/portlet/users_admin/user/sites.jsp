...
>
	...
	>
		...
		<c:if test="<%= !portletName.equals(PortletKeys.MY_ACCOUNT) && !GroupPermissionUtil.hasAdminAndOwnerRoleRestriction(permissionChecker, group.getGroupId(), selUser.getUserId()) %>">
			<liferay-ui:search-container-column-text>
