...
<aui:form action="<%= editArchivedSetupsURL %>" method="post" name="fm">
	...
	List<ArchivedSettings> archivedSettingsList = ArchivedSettingsFactoryUtil.getArchivedSettingsList(scopeGroupId, selPortlet.getRootPortletId());
	...
	for (int i = 0; i < results.size(); i++) {
		...
		//archivedSettings = archivedSettings.toEscapedModel();
