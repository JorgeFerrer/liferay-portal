...
String[] languageIds = StringUtil.split(groupTypeSettings.getProperty(PropsKeys.LOCALES));
Locale[] locales = LocaleUtil.fromLanguageIds(languageIds);

String languageId = GetterUtil.getString(groupTypeSettings.getProperty("languageId"), user2.getLanguageId());
