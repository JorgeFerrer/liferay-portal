...
<c:choose>
	<c:when test='<%= !selGroup.isLayoutSetPrototype() && (portletName.equals(PortletKeys.GROUP_PAGES) || portletName.equals(PortletKeys.MY_PAGES) || portletName.equals("com_liferay_user_groups_admin_web_portlet_UserGroupsAdminPortlet") || portletName.equals(PortletKeys.USERS_ADMIN)) %>'>

		<%
		Group liveGroup = layoutsAdminDisplayContext.getLiveGroup();
		%>

		<c:if test='<%= (portletName.equals(PortletKeys.GROUP_PAGES) && !layout.isTypeControlPanel()) || portletName.equals("com_liferay_user_groups_admin_web_portlet_UserGroupsAdminPortlet") || portletName.equals(PortletKeys.USERS_ADMIN) %>'>
			<liferay-ui:header
