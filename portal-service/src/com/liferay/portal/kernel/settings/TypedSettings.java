...
public class TypedSettings {
	...
	public void reset(String key) {
		_decoratedSettings.getModifiableSettings().reset(key);
	}
	...
	public void setValue(String key, String value) {
		_decoratedSettings.getModifiableSettings().setValue(key, value);
	}

	public void setValues(String key, String[] values) {
		_decoratedSettings.getModifiableSettings().setValues(key, values);
	}
