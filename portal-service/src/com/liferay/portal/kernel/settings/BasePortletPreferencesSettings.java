 ...
 * @author Iván Zaera
 */
public abstract class BasePortletPreferencesSettings
	extends BaseModifiableSettings {

	public BasePortletPreferencesSettings() {
	}

	public BasePortletPreferencesSettings(Settings parentSettings) {
	...
	protected String doGetValue(String key) {
		...
		return normalizeValue(portletPreferences.getValue(key, null));
	}
	...
	protected String[] doGetValues(String key) {
		...
		return normalizeValues(portletPreferences.getValues(key, null));
	}

	protected abstract PortletPreferences getPortletPreferences();
	...
	private static Log _log = LogFactoryUtil.getLog(
		BasePortletPreferencesSettings.class);
